...
form.addEventListener("submit", async (e) => {
  ...
  statusBox.textContent = "Gemini is analyzing your device profile...";
  ...
  try {
    ...
    statusBox.textContent = data.saved
      ? "Recommendation generated and saved."
      : "Recommendation generated. Database save reported an issue.";
  } catch (err) {
    statusBox.textContent = "Error: " + err.message;
  } finally {
    askBtn.disabled = false;
    askBtn.textContent = "GET AI SENSITIVITY";
  }
});
